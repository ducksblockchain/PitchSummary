...
contract SMTFaucet {
    ...
    constructor() public {
        token = IERC20Faucet(0xE18BfFd4F2f3149a28f6E0541367850E7dE629E3);
        owner = msg.sender;
    }
    ...
    function send() external {
        require(token.balanceOf(address(this)) > 0,"FaucetError: Empty");
